...
const fetchAllGroupsBySchool = async (user) => {
  if (user.role === "Student") {
    const res = await axios.post('https://osimseder.onrender.com/api/student/groups/',{schoolId:user.schoolId},{headers: {accessToken: localStorage.getItem('accessToken')}} );
